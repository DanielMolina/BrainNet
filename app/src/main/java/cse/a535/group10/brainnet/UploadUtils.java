...
public class UploadUtils extends AsyncTask<String, Void, Boolean> {
    private OnEventListener<Boolean> mCallBack;

    UploadUtils(OnEventListener<Boolean> callback) {
        mCallBack = callback;
    }
    ...
    protected void onPostExecute(Boolean result) {
        ...
        Log.d("Upload File", result ? "File Uploaded successfully!!" : "File Uploaded failed");
